...
const Navbar = ({ user , onHandleLogout})=>{
	...
	{
			btnList.push(
				<User key = {1}>{user}님</User>
			);
			btnList.push(
				<Button key={2} FontSize = "1.0rem" Color = "rgb(108,117,125)" HoverColor="rgb(90,98,104)" MarginLeft = "10px" Width = "80px" onClick = {onHandleLogout} >Log out</Button>
			);
	}
	else
	{
